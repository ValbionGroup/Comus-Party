...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 15 nov. 2024 à 08:25
...
INSERT INTO `cp_achieve` (`success_id`, `player_uuid`, `date`) VALUES
(1, 'uuid1', '2024-11-13 16:18:39'),
...
INSERT INTO `cp_article` (`id`, `name`, `description`, `type`, `file_path`, `price_point`, `price_euro`, `created_at`, `updated_at`) VALUES
(1, 'Banner One', 'Description for banner one', 'banner', '/img/banner1.png', 100, 2.99, '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
(2, 'Profile Pic One', 'Description for profile picture one', 'pfp', '/img/pfp1.png', 200, 4.99, '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
(3, 'Banner Two', 'Description for banner two', 'banner', '/img/banner2.png', 150, 3.99, '2024-11-14 08:15:01', '2024-11-14 08:15:01'),
(4, 'Profile Pic Two', 'Description for profile picture two', 'pfp', '/img/pfp2.png', 250, 5.99, '2024-11-14 08:15:01', '2024-11-14 08:15:01');
...
INSERT INTO `cp_game` (`id`, `name`, `description`, `img_path`, `state`, `created_at`, `updated_at`) VALUES
(1, 'Game One', 'First game description', '/img/game1.png', 'available', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
(2, 'Game Two', 'Second game description', '/img/game2.png', 'maintenance', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
(3, 'Game Three', 'Third game description', '/img/game3.png', 'available', '2024-11-14 08:15:01', '2024-11-14 08:15:01'),
(4, 'Game Four', 'Fourth game description', '/img/game4.png', 'maintenance', '2024-11-14 08:15:01', '2024-11-14 08:15:01');
...
INSERT INTO `cp_game_record` (`uuid`, `game_id`, `hosted_by`, `state`, `created_at`, `updated_at`) VALUES
('game_rec_uuid1', 1, 'uuid1', 'started', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_invoice` (`id`, `player_uuid`, `payment_type`, `created_at`) VALUES
(1, 'uuid1', 'card', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_moderator` (`uuid`, `user_id`, `first_name`, `last_name`, `created_at`, `updated_at`) VALUES
('mod_uuid1', 1, 'John', 'Doe', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_penalty` (`id`, `created_by`, `cancelled_by`, `penalized_uuid`, `reason`, `duration`, `type`, `cancelled_at`, `created_at`, `updated_at`) VALUES
(1, 'mod_uuid1', NULL, 'uuid2', 'Inappropriate behavior', 30, 'muted', NULL, '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_played` (`game_uuid`, `player_uuid`) VALUES
('game_rec_uuid1', 'uuid1'),
...
INSERT INTO `cp_player` (`uuid`, `user_id`, `username`, `xp`, `elo`, `comus_coin`, `created_at`, `updated_at`) VALUES
('uuid1', 1, 'JohnDoe', 500, 1200, 100, '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_pswd_reset_token` (`user_id`, `token`, `created_at`) VALUES
(1, 'reset_token_1', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_report` (`id`, `object`, `description`, `treated`, `treated_by`, `reported_uuid`, `sender_uuid`, `created_at`, `updated_at`) VALUES
(1, 'language', 'Inappropriate language used', 1, 'mod_uuid1', 'uuid1', 'uuid2', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_success` (`id`, `depend_on`, `name`, `description`, `type`, `prize`, `created_at`, `updated_at`) VALUES
(1, NULL, 'First Win', 'Win your first game', 'bronze', '100xp', '2024-11-13 15:18:39', '2024-11-13 15:18:39'),
...
INSERT INTO `cp_tag` (`id`, `name`) VALUES
(1, 'Action'),
(2, 'Adventure'),
(3, 'Puzzle'),
(4, 'Strategy');
...
INSERT INTO `cp_tagged` (`tag_id`, `game_id`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4);
...
INSERT INTO `cp_user` (`id`, `email`, `password`, `email_verified_at`, `email_verif_token`, `disabled`, `created_at`, `updated_at`) VALUES
(1, 'john.doe@example.com', '$2y$10$pWjH9MFAmeO8quFTZWSube4mx1KUiYiNXgIf0z9LrOA5TafaAWEw.', '2024-11-13 16:18:39', 'token1', 0, '2024-11-13 15:18:39', '2024-11-13 15:19:34'),
(2, 'jane.doe@example.com', '$2y$10$Ms.jZ7V7Su0oC7o5PK3uOuT7rmp7al21xOF2gUHd/a/Ozq14/trHi', '2024-11-13 16:18:39', 'token2', 0, '2024-11-13 15:18:39', '2024-11-13 15:19:51'),
(3, 'alex.smith@example.com', 'hashed_password3', '2024-11-14 09:15:01', 'token3', 0, '2024-11-14 08:15:01', '2024-11-14 08:15:01'),
(4, 'lisa.wong@example.com', 'hashed_password4', '2024-11-14 09:15:01', 'token4', 0, '2024-11-14 08:15:01', '2024-11-14 08:15:01');
...
INSERT INTO `cp_winned` (`game_uuid`, `player_uuid`) VALUES
('game_rec_uuid1', 'uuid1'),
('game_rec_uuid2', 'uuid2'),
('game_rec_uuid3', 'uuid3'),
('game_rec_uuid4', 'uuid4');
