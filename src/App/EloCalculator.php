...
class EloCalculator
{
     ...
     * @return float|int Nouvel Elo du joueur
     */
    public static function calculateNewElo(int $eloPlayer, int $averageElo, float $result): float|int
    {
     ...
     * @return float|int
     */
    protected static function getExpectedScore(int $eloPlayer, int $averageElo): float|int
    {
