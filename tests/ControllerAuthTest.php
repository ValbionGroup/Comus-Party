...
class ControllerAuthTest extends TestCase
{
    ...
    public function testAuthenticateOnNullEmail(): void
    {
        ...
        $this->assertFalse($this->controller->login(null, 'hashed_password1', false, 'XXXX.DUMMY.TOKEN.XXXX'));
    }
    ...
    {
        $this->assertNotNull($this->controller, 'Controller is null.');
        $this->assertFalse($this->controller->login('john.doe@example.com', null, false, 'XXXX.DUMMY.TOKEN.XXXX'));
    }
    ...
    {
        $this->assertNotNull($this->controller, 'Controller is null.');
        $this->controller->login('john.doe@example.com', 'hashed_password1', false, 'XXXX.DUMMY.TOKEN.XXXX');
    }
    ...
    {
        $this->assertNotNull($this->controller, 'Controller is null.');
        $this->assertFalse($this->controller->login('john.doeexample.com', 'hashed_password1', false, 'XXXX.DUMMY.TOKEN.XXXX'));
    }
    ...
    {
        $this->assertNotNull($this->controller, 'Controller is null.');
        $this->assertFalse($this->controller->login('john.danny@example.com', 'hashed_password1', false, ''));
    }
